...
namespace BaseProject
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            identityDbContext.Database.Migrate(); // otomatik migration iþlemi. veritabaný yoksa oluþturur. Uygulanmayan migrationlarý uygular
                                                  // böylece update-database iþlemine gerek kalmaz
